...
alter table location_info lock allpages
go

grant references on location_info
   to public /*dbo*/
grant select on location_info
   to public /*dbo*/
grant insert on location_info
   to  /*dbo*/
grant delete on location_info
   to  /*dbo*/
grant update on location_info
   to  /*dbo*/
